        ...
        <div class="source-box clear" :style='{"padding-top": showEntrance? "50px" : "10px"}'>
            <div class="top left">
                ...
                <ul class="left">
                    ...
                    <li class="original"><span v-text="isOriginal == 1 ? '原创':'转载'"></span>&nbsp;<span v-text="forwardFrom"></span></li>
                </ul>
...
<script data-main="../resources/js/articleMain" src="../resources/js/require.js"></script>
