...
public class RandomUtil {
	...
	public final static String getFixLenthString(int strLength) {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<10000000;i++){
			String dddd = generateLowerString(10);
			if (map.get(dddd) == null){
				map.put(dddd,dddd);
				System.out.println("随即串：" + dddd);
			}
			else{
				System.out.println("出现重复的随即串：" + dddd);
			}
		}
